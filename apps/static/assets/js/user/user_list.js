$(function() {
    ...
    // user.on("click", "th#user", function() {
    //     if ($("th#user").hasClass("selected")){
    //         $("th#user > input").prop('checked', false);
    //         user.rows().deselect();
    //         $("th#user").removeClass("selected");
    //     }else{
    //         $("th#user > input").prop('checked', true);
    //         user.rows().select();
    //         $("th#user").addClass("selected");
    //     }
    // }).on("select deselect", function(){
    //     if(user.rows({
    //         selected: true
    //     }).count() !== user.rows().count()){
    //         $("th#user").removeClass("selected");
    //     }else{
    //         $("th#user").addClass("selected");  
    //     }
    //     selectedUsers = []
    //     var selectedRows = user.rows( { selected: true } ).data().pluck(0).toArray();
